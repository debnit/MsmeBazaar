...
from .integrations import bank_integration, nbfc_integration
...
app.include_router(underwriting_routes.router, prefix="/api/v1/underwriting", tags=["underwriting"])
app.include_router(disbursement_routes.router, prefix="/api/v1/disbursement", tags=["disbursement"])

@app.get("/")
async def root():
    """Health check endpoint"""
    return {"message": "Loan Service is running", "version": "1.0.0"}
